...
console.log (output);
// below is my attempt and it doesn't work so it's commented out. above is marks which works great. 
// console.log(unsortedArr);
// function bubsort (Arr) {
//   for ( x = Arr.length; x > 0; x--) {
//     // console.log(Arr[x] + "compared to " + Arr[x-1]);
//      if (Arr[x] < Arr[x-1]) {
//        var n = Arr[x]; 
//        Arr[x-1] = n; 
//        Arr[x] = Arr[x-1];
...
//   }
// };
// console.log(bubsort(unsortedArr));
// console.log(unsortedArr);
